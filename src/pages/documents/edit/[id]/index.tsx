        ...
        {isLoading || (!formik.values && !error) ? (
          ...
          <form onSubmit={formik.handleSubmit}>
            ...
            <FormControl
              ...
              alignItems="center"
              mb="4"
              isInvalid={!!formik.errors?.is_audited}
            >
              <FormLabel htmlFor="switch-is_audited">Is Audited</FormLabel>
              <Switch
                id="switch-is_audited"
                name="is_audited"
                onChange={formik.handleChange}
                value={formik.values?.is_audited ? 1 : 0}
              />
              {formik.errors?.is_audited && <FormErrorMessage>{formik.errors?.is_audited}</FormErrorMessage>}
            </FormControl>
